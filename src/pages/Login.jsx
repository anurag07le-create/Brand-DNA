...
import puchoLogo from '../assets/pucho_logo_login.png';
...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-[#FAFAFF] relative flex items-center justify-center p-4 lg:p-8 overflow-x-hidden font-sans">
            ...
            <div className="fixed top-0 left-0 w-[500px] lg:w-[800px] h-[500px] lg:h-[800px] bg-purple-600/30 rounded-full blur-[80px] lg:blur-[120px] pointer-events-none -translate-x-1/2 -translate-y-1/2"></div>
            <div className="fixed bottom-0 right-0 w-[500px] lg:w-[800px] h-[500px] lg:h-[800px] bg-blue-600/30 rounded-full blur-[80px] lg:blur-[120px] pointer-events-none translate-x-1/2 translate-y-1/2"></div>
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden h-full w-full z-20 hidden md:block">
                ...
                <Mascot
                    imageSrc={mascot3}
                    x="bottom-[30%] left-6 md:bottom-[06%] md:left-[0%]"
                    delay={0.8}
                    size="w-12 h-12 md:w-16 md:h-16"
            ...
            {/* Mobile Logo - Relative to flow */}
            {/* Mobile Logo - Relative to flow */}
            <div className="flex justify-center md:hidden pt-8 pb-4 z-20 shrink-0">
                <img src={puchoLogo} alt="Pucho.ai" className="h-8" />
            </div>

            {/* Main Content Container */}
            <div className="w-full max-w-7xl mx-auto flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-12 lg:gap-24 relative z-10 items-center justify-center h-full pt-4 md:pt-0">

                {/* Left Side: Marketing Content */}
                <div className="text-center md:text-left space-y-4 md:space-y-8 md:pl-8 lg:pl-16 mb-8 md:mb-0 mt-8 md:mt-0">
                    {/* Desktop/Tablet Logo */}
                    <div className="hidden md:flex justify-start mb-8 lg:mb-16">
                        <img src={puchoLogo} alt="Pucho.ai" className="h-8 lg:h-12" />
                    </div>

                    <div className="space-y-2 md:space-y-4 lg:space-y-6">
                        <div className="space-y-1 md:space-y-2">
                            <div className="font-semibold text-[#111834] text-sm md:text-base lg:text-lg">Pucho.ai's Virtual Try On</div>
                            <div className="text-[10px] md:text-[11px] lg:text-xs font-bold text-purple-600 tracking-wider uppercase">VIRTUAL CLOSET & TRY ON</div>
                        </div>
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-[70px] font-bold text-[#111834] leading-[1.1] md:leading-[1] lg:leading-[0.95] tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-[#111834] to-[#4338ca]">
                            Curate.<br />
                            <span className="text-[#8b5cf6]/80">Visualize.</span><br />
                            Wear.
                        </h1>
                        ...
                        <p className="text-[#111834] text-xs md:text-sm lg:text-base leading-relaxed max-w-md mx-auto md:mx-0 opacity-70 hidden md:block">
                            Advanced AI for your digital wardrobe. Organize your style and visualize outfits instantly with our virtual try-on technology.
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    font-semibold text-[18px] leading-[150%] text-white
            ...
            {/* Copyright Footer */}
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 hidden md:block text-gray-400 text-xs text-center">
                © 2026 Pucho.ai. All rights reserved.
            </div>
        </div>
    );
};
